    ...
    >
        ...
        >
            <div class="grid grid-cols-1 gap-y-4">
                ...
                <a-form-model-item label="Nơi đăng ký" prop="addressRegister">
                    <a-input v-model="form.addressRegister" placeholder="Nhập nơi đăng ký" />
                </a-form-model-item>
        ...
        methods: {
            ...
            open(consultation) {
                ...
                this.form = {
                    ...
                    addressRegister: consultation ? consultation.addressRegister : '',
