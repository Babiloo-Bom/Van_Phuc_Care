        ...
        <div class="w-full card">
            <div class="flex items-end justify-between">
                ...
                <div class="flex items-center gap-1">
                    ...
                    <a-button type="primary" class="" @click="$refs.createModal.open({folder: activeKey, folderId: $route.params.id })">
                        Thêm thư mục
                    </a-button>
                </div>
            </div>
...
<script>
    ...
    import CreateModal from '@/components/files/CreateModal.vue';
        ...
        watch: {
            '$route.query': {
                async handler() {
                    ...
                    await this.$store.dispatch('documents/fetchFolders', _omit({ ...this.$route.query, folderId: this.$route.params.id }, ['type']));
