                ...
                >
                    <div class="grid grid-cols-2 gap-4 mb-2">
                        ...
                        >
                            ...
                            />
                            <p v-if="handleExisted(form.email)" class="m-0 mt-2 text-[12px] text-[red]">
                                *Tài khoản {{ form.email }} đã được cấp quyền
                            </p>
                        </a-form-model-item>
                    </div>
                </a-form-model>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            ...mapState('settings/members', ['members']),
        },
        ...
        methods: {
            ...
            async sendInvite() {
                try {
                    this.loading = true;
                    await this.$store.dispatch('settings/members/create', {
                        ...this.form,
                        permisstions: _uniqBy(this.form.permisstions),
                    });
                    await this.$store.dispatch('settings/contacts/fetchDetail');
                    this.$router.push('/settings/members');
            ...
            handleExisted(email) {
                return this.members?.some((e) => e.email === email);
            },
