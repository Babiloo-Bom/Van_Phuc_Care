  ...
  >
    <div class="flex items-center justify-between px-8 w-full">
      ...
      <div class="flex items-center gap-4 relative">
        ...
        <!-- User Profile -->
        <div
          class="flex items-center gap-3 px-3 py-2 rounded-xl cursor-pointer hover:bg-gray-50 transition-all"
        ...
        <div
          v-if="showUserMenu"
          class="absolute top-[calc(100%+8px)] right-0 min-w-[220px] bg-white border border-gray-200 rounded-xl shadow-lg overflow-hidden z-[100]"
        >
          <NuxtLink
            to="/profile"
            class="flex items-center gap-3 px-4 py-3 text-gray-700 text-sm transition-all hover:bg-gray-50 hover:text-blue-500 no-underline cursor-pointer"
            @click="closeUserMenu"
          >
          ...
          <button
            class="flex items-center gap-3 px-4 py-3 text-gray-700 text-sm transition-all hover:bg-red-50 hover:text-red-500 border-none bg-transparent w-full text-left cursor-pointer"
            @click="handleLogout"
          >
            <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none">
              <path
