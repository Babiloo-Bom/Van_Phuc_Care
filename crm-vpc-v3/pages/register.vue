...
const handleVerifyEmail = async () => {
  console.log('🔍 CRM handleVerifyEmail called with OTP:', otpCode.value)
  verifyError.value = ''

  const result = await verifyEmail(otpCode.value)
  console.log('🔍 CRM verifyEmail result:', result)
  console.log('🔍 CRM verifyEmail result.success:', result.success)
  console.log('🔍 CRM verifyEmail result.error:', result.error)
