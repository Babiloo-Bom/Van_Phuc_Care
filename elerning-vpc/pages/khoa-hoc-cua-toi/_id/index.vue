                ...
                <div class="grid grid-cols-12 md:gap-12">
                    <div class="col-span-12 lg:col-span-8">
                        <div>
                            ...
                            <div class="mt-6">
                                <h2 class="text-4xl font-bold text-prim-100 mb-1">
                                    {{ course.title }}
                                </h2>
                            ...
                            <div class="mt-6">
                                <h1 class="text-prim-100 text-3xl">
                                    1. Giới thiệu khóa học
                                </h1>
                                <p v-html="course.descriptions" />
                            </div>
                            <div class="hidden sm:flex justify-center mt-6">
                                <a-button class="!w-[250px] !flex !items-center !bg-prim-100 !justify-center !gap-2 !py-3 !rounded-sm !h-[48px]" @click="openCourse">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="24"
                                        height="24"
                    ...
                    <div class="col-span-12 lg:col-span-4">
                        <div>
                            <div>
                                <a-button class="!w-full !flex !items-center !bg-prim-100 !justify-center !gap-2 !py-3 !rounded-sm !h-[48px]" @click="openCourse">
                                    <svg
                                        xmlns="http://www.w3.org/2000/svg"
                                        width="24"
                                        height="24"
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            openCourse() {
                // console.log(this.course.chapters[0]);
                this.$router.push(`/khoa-hoc-cua-toi/${this.course.slug}/${this.course.chapters[0]?.lessons[0]?.index}?chapter=0`);
            },
