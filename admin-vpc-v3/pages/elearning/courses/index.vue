<template>
  <div class="courses-management-page">
            ...
            <template v-else-if="column.key === 'title'">
              <div class="course-info">
                <div class="course-title">
                  {{ record.title || record.name || "Chưa có tiêu đề" }}
                </div>
            ...
            <a-row :gutter="16">
              ...
              <a-col :span="24">
                <a-form-item label="Ảnh đại diện" name="thumbnail">
                  ...
                  <div
                    v-if="formData.thumbnail && thumbnailFileList.length === 0"
              ...
              <a-col :span="24">
                <a-form-item label="Ảnh banner" name="banner">
                  ...
                  <div
                    v-if="formData.banner && bannerFileList.length === 0"
                    style="margin-top: 8px"
                  >
                    <img
                      :src="formData.banner"
                  ...
                  <div style="color: #8c8c8c; font-size: 12px; margin-top: 4px">
                    Ảnh banner hiển thị ở trang chi tiết khóa học (khuyến nghị:
                    1200x400px)
                  </div>
                </a-form-item>
              </a-col>
                ...
                <a-form-item label="Video giới thiệu">
                  ...
                  >
                    ...
                    <div style="flex: 1">
                      ...
                      <!-- Video Status -->
                      <div
                        v-if="formData.introVideoStatus"
                        style="margin-top: 8px"
                        :key="`intro-video-status-${formData.introVideoStatus}-${uploadingIntroVideo}`"
                      >
                        <a-tag
                          :color="getStatusColor(formData.introVideoStatus)"
                        >
                          <!-- CRITICAL FIX: Hardcode 'Sẵn sàng' when status is 'ready' to avoid any reactive issues -->
                          <span v-if="formData.introVideoStatus === 'ready'"
                            >Sẵn sàng</span
                          >
                          <!-- Only show progress when actively uploading AND status is not ready -->
                          <template
                            v-else-if="
                              uploadingIntroVideo === true &&
                        ...
                        >
                          ...
                          >
                            ...
                            >
                              <span>
                                <strong
                                  >{{
                                    introVideoUploadProgress.percent
                                  }}%</strong
                                >
                                <span
                                  style="
                              ...
                              >
                                ...
                                {{
                                  formatTimeRemaining(
                                    introVideoUploadProgress.timeRemaining,
                                  )
                                }}
                              </span>
                              <span
                            ...
                            >
                              <span>
                                <span
                                  ...
                                  "
                                >
                                  Đang upload video lên R2:
                                  {{
                                    formatFileSize(
                                      introVideoUploadProgress.uploaded,
                                    )
                                  }}
                                  /
                                  {{
                                    formatFileSize(
                                      introVideoUploadProgress.total,
                                    )
                                  }}
                                </span>
                                <span
                                ...
                                <span
                                  ...
                                  "
                                >
                                  Đang convert video sang HLS (có thể mất vài
                                  phút)...
                                </span>
                                <span
                                  v-else-if="
                                ...
                                >
                                  ({{
                                    formatFileSize(
                                      introVideoUploadProgress.speed,
                                    )
                                  }}/s)
                                </span>
                              </span>
                          ...
                          <div
                            v-if="introVideoUploadProgress.percent < 100"
                            style="margin-top: 8px"
                          >
                            <a-button
                              size="small"
                              danger
                              @click="handleRemoveIntroVideo"
                            >
                        ...
                        <div
                          v-if="formData.introVideoStatus === 'error'"
                          style="margin-top: 8px"
                        >
                          <a-alert
                            :message="
                      ...
                      <div
                        v-if="
                          formData.introVideo && introVideoFileList.length === 0
                        "
                        style="margin-top: 8px"
                      >
                        <video
                      ...
                      >
                        <!-- HLS URL -->
                        <div
                          v-if="formData.introVideoHlsUrl"
                          style="margin-bottom: 8px"
                        >
                          <div
                            style="
                          ...
                          <a
                            :href="formData.introVideoHlsUrl"
                            target="_blank"
                            style="
                              font-size: 12px;
                        ...
                        >
                          <div style="font-size: 12px; color: #666">
                            ...
                            <span
                              v-if="formData.introVideoQualityMetadata.codec"
                              style="margin-left: 4px"
                            >
                              {{ formData.introVideoQualityMetadata.codec }}
                            </span>
                            <span
                              v-if="formData.introVideoQualityMetadata.fps"
                              style="margin-left: 4px"
                            >
                              {{ formData.introVideoQualityMetadata.fps }}fps
                            </span>
                            <span
                              v-if="formData.introVideoQualityMetadata.bitrate"
                              style="margin-left: 4px"
                            >
                              {{ formData.introVideoQualityMetadata.bitrate }}
                            </span>
                            <span
                              v-if="formData.introVideoQualityMetadata.segments"
                              style="margin-left: 4px"
                            >
                              ({{ formData.introVideoQualityMetadata.segments }}
                              segments)
                            </span>
                          </div>
                        </div>
                      ...
                      <div
                        v-if="
                          introVideoFileList.length > 0 &&
                          introVideoFileList[0] &&
                          !introVideoFileList[0].url &&
                          !uploadingIntroVideo
                        "
                        style="margin-top: 8px; color: #8c8c8c; font-size: 12px"
                      >
                        Video sẽ được upload khi bạn nhấn "Tạo mới" hoặc "Cập
                        nhật"
                      </div>
                    </div>
                      ...
                      <a-form-item label="Thumbnail video">
                        ...
                        <div
                          v-if="
                            ...
                            introVideoThumbnailFileList.length === 0
                          "
                          style="margin-top: 8px"
                        >
                          <img
          ...
          <a-tab-pane key="chapters" tab="Nội dung khóa học">
            <div class="chapters-section">
              <div
                ...
                :key="chapter._id || chapter._clientId || chapterIndex"
                class="chapter-item"
                style="
                  margin-bottom: 24px;
                  padding: 16px;
              ...
              >
                ...
                <div style="margin-top: 16px">
                  ...
                  >
                    ...
                    >
                      <UpOutlined
                        v-if="!isChapterLessonsCollapsed(chapterIndex)"
                      />
                      <DownOutlined v-else />
                      {{
                        isChapterLessonsCollapsed(chapterIndex)
                          ? "Mở rộng"
                          : "Thu gọn"
                      }}
                    </a-button>
                  ...
                  <div v-show="!isChapterLessonsCollapsed(chapterIndex)">
                    <div
                      ...
                      :key="lesson._id || lesson._clientId || lessonIndex"
                      style="
                        margin-top: 12px;
                        padding: 16px;
                        background: #f5f5f5;
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          <strong
                            >B{{ lessonIndex + 1 }}:
                            {{ lesson.title || "Chưa có tiêu đề" }}</strong
                          >
                        </div>
                        <div
                        ...
                        >
                          ...
                          <a-button
                            ...
                            size="small"
                            @click="
                              toggleLessonCollapse(chapterIndex, lessonIndex)
                            "
                            style="display: flex; align-items: center; gap: 4px"
                          >
                            <UpOutlined
                              v-if="
                                !isLessonCollapsed(chapterIndex, lessonIndex)
                              "
                            />
                            <DownOutlined v-else />
                            {{
                      ...
                      <div
                        v-show="!isLessonCollapsed(chapterIndex, lessonIndex)"
                      >
                        <a-row :gutter="16">
                          <a-col :span="24">
                          ...
                          <a-col :span="24">
                            <a-form-item label="Hiển thị các phần">
                              <a-space>
                                ...
                                <a-checkbox
                                  v-model:checked="lesson.showDocument"
                                >
                                  Tài liệu đính kèm
                                </a-checkbox>
                          ...
                          <a-col :span="12">
                            <a-form-item label="Nội dung bài học">
                              <a-select
                                v-model:value="lesson.type"
                                style="width: 100%"
                              >
                                <a-select-option value="video"
                                  >Video</a-select-option
                                >
                                <a-select-option value="text"
                                  >Văn bản</a-select-option
                                >
                                <a-select-option value="document"
                                  >Tài liệu</a-select-option
                                >
                                <a-select-option value="quiz"
                                  >Trắc Nghiệm</a-select-option
                                >
                              </a-select>
                            </a-form-item>
                          </a-col>
                                ...
                                >
                                  ...
                                  <div style="flex: 1">
                                        ...
                                        >
                                          <span>
                                            ...
                                            <span
                                              ...
                                              "
                                            >
                                              Đang chờ xử lý (video đã upload
                                              xong)...
                                            </span>
                                            <span
                                              v-else-if="
                                              ...
                                              "
                                            >
                                              Đang convert video sang HLS (có
                                              thể mất vài phút)...
                                            </span>
                                            <span
                                              v-else-if="
                                    ...
                                    <div
                                      v-else-if="
                                        lesson.videoUrl &&
                                        !lesson.videoFileList?.length
                                      "
                                      style="margin-top: 8px"
                                    >
                                      <a-tag
                                        color="green"
                                        v-if="lesson.videoStatus === 'ready'"
                                        >Video đã tải lên</a-tag
                                      >
                                      <a-tag
                                        color="orange"
                                        v-else-if="
                                      ...
                                      <a-tag
                                        color="blue"
                                        v-else-if="
                                          lesson.videoStatus === 'queueing'
                                        "
                                        >Đang chờ xử lý...</a-tag
                                      >
                                      <a-tag
                                        color="red"
                                        v-else-if="
                                    ...
                                    <div
                                      v-if="
                                        ...
                                        (lesson.videos[0].hlsUrl ||
                                          (lesson.videos[0].qualityMetadata &&
                                            (lesson.videos[0].qualityMetadata
                                              .resolution ||
                                              lesson.videos[0].qualityMetadata
                                                .codec)))
                                  ...
                                  <div style="flex-shrink: 0">
                                    <a-form-item label="Thumbnail video">
                                      <a-upload
                                        ...
                                        @change="
                                          (info: any) =>
                                            handleLessonVideoThumbnailChange(
                                              chapterIndex,
                                              lessonIndex,
                                              info,
                                            )
                                        ...
                                        @remove="
                                          () =>
                                            handleRemoveLessonVideoThumbnail(
                                              chapterIndex,
                                              lessonIndex,
                                            )
                                        "
                              ...
                              <a-form-item label="Tài liệu bài học">
                                ...
                                <div
                                  v-if="
                                    ...
                                    (lesson.documentFileList &&
                                      lesson.documentFileList.length > 0)
                                  "
                                  style="margin-top: 8px"
                                >
                                  <a-tag color="green"
                                    >Tài liệu đã tải lên</a-tag
                                  >
                                  <div
                                    style="
                                      font-size: 12px;
                                  ...
                                  >
                                    {{
                                      lesson.documentFileList?.[0]?.name ||
                                      lesson.documents?.[0]?.fileName ||
                          ...
                          <template v-if="lesson.type === 'quiz'">
                            <a-col :span="24">
                              ...
                              >
                                <div
                                  v-for="(question, questionIndex) in lesson
                                    .quiz?.questions || []"
                                  :key="
                                ...
                                >
                                  ...
                                  >
                                    <strong
                                      >Câu hỏi {{ questionIndex + 1 }}:</strong
                                    >
                                    <a-button
                                      type="text"
                                      danger
                ...
                <a-form-item label="Ảnh đại diện giảng viên">
                  ...
                  <div
                    v-if="
                      ...
                      instructorAvatarFileList.length === 0
                    "
                    style="margin-top: 8px"
                  >
                    <img
                ...
                <template #renderItem="{ item, index }">
                  <a-list-item>
                    <a-list-item-meta>
                      <template #avatar>
                        <a-avatar
                          :src="item.userAvatar || '/images/avatar-demo.png'"
                        />
                      </template>
                      <template #title>
                        <div
                        ...
                        >
                          ...
                          <a-space>
                            ...
                            <a-button
                              ...
                              danger
                              size="small"
                              @click="deleteReview(item._id, index)"
                            >
                              <DeleteOutlined /> Xóa
                            </a-button>
                          </a-space>
      ...
      <div v-if="viewingCourse" class="course-detail-view">
        ...
        <a-descriptions title="Thông tin cơ bản" bordered :column="2">
          ...
          <a-descriptions-item label="Trạng thái">
            <a-tag
              :color="viewingCourse.status === 'active' ? 'success' : 'default'"
            >
              {{
          ...
          <a-descriptions-item label="Tags" :span="2">
            <a-tag
              v-for="tag in viewingCourse.tags || []"
              :key="tag"
              style="margin: 4px"
            >
              {{ tag }}
        ...
        >
          ...
          <a-descriptions-item label="Đánh giá">
            {{ viewingCourse.rating?.average || 0 }}/5 ({{
              viewingCourse.rating?.count || 0
            }}
            đánh giá)
          </a-descriptions-item>
        </a-descriptions>
    ...
    <a-modal
      ...
      "
    >
      <a-form ref="reviewFormRef" :model="reviewFormData" layout="vertical">
        <a-form-item
        ...
        <template v-if="reviewFormData.userInputType === 'select'">
          <a-form-item
            ...
            :rules="[
              {
                required: reviewFormData.userInputType === 'select',
          ...
          >
            <a-select
              ...
              @focus="
                () => {
                  if (usersList.value.length === 0) fetchUsersList();
                }
              "
            >
              <a-select-option
              ...
              >
                <div style="display: flex; align-items: center; gap: 8px">
                  ...
                  <span
                    v-if="user.email && (user.fullname || user.name)"
            ...
            >
              ...
              <div>
                ...
                <div style="font-size: 12px; color: #999">
                  Ảnh đại diện và tên đã được tự động lấy từ hệ thống
                </div>
              </div>
            </div>
          </a-form-item>
        ...
        <template v-if="reviewFormData.userInputType === 'manual'">
          <a-form-item
            ...
            :rules="[
              {
                required: reviewFormData.userInputType === 'manual',
          ...
          <a-form-item label="Ảnh đại diện" name="userAvatar">
            <a-upload
            ...
            <div
              v-if="
                reviewFormData.userAvatar &&
                reviewAvatarFileList.length === 0 &&
        ...
        <a-form-item label="Ngày đánh giá" name="reviewDate">
          <a-date-picker
...
const modalTitle = computed(() =>
  editingCourse.value ? "Sửa khóa học" : "Tạo khóa học mới",
);
...
const lessonVideoUploadProgress = reactive<
  Record<
    string,
    {
      percent: number;
...
const retryIntroVideoUpload = async () => {
  if (
    introVideoFileList.value.length > 0 &&
    introVideoFileList.value[0].originFileObj
  ) {
...
const handleLessonVideoThumbnailChange = async (
  chapterIndex: number,
  lessonIndex: number,
  info: any,
) => {
...
const handleRemoveLessonVideoThumbnail = (
  chapterIndex: number,
  lessonIndex: number,
) => {
  const lesson = formData.chapters[chapterIndex].lessons[lessonIndex];
...
const handleDeleteLessonVideo = async (
  ...
  Modal.confirm({
    title: "Xóa video",
    content:
      "Bạn có chắc chắn muốn xóa video này? Video và tất cả các file liên quan (HLS, thumbnail) sẽ bị xóa vĩnh viễn.",
    okText: "Xóa",
    okType: "danger",
    cancelText: "Hủy",
    onOk: async () => {
      try {
        ...
        if (lesson._id && lesson.videos && lesson.videos.length > 0) {
          ...
          if (editingCourse.value?._id) {
            const updatedChapters = formData.chapters.map(
              (ch: any, chIdx: number) => ({
                ...ch,
                index: chIdx,
                lessons:
        ...
        message.error(
          error.message || "Không thể xóa video. Vui lòng thử lại.",
        );
      }
    },
  });
...
const uploadFileToMinIO = async (
  ...
  try {
    ...
    const url = apiHost
      ? `${apiHost}/api/uploads/minio?folder=${folder}`
      : `/api/uploads/minio?folder=${folder}`;
...
const uploadVideoToR2 = async (
  ...
  let url = apiHost
    ? `${apiHost}/api/uploads/video?folder=${folder}`
    : `/api/uploads/video?folder=${folder}`;
  if (lessonId) {
  ...
  return new Promise((resolve, reject) => {
    ...
    const estimatedR2UploadSeconds = Math.max(
      5,
    ...
    if (progressKey) {
      if (!lessonVideoUploadProgress[progressKey]) {
        ...
        lessonVideoUploadProgress[progressKey].estimatedProcessingTime =
          estimatedProcessingSeconds;
        lessonVideoUploadProgress[progressKey].estimatedR2UploadTime =
          estimatedR2UploadSeconds;
      }
    } else {
      introVideoUploadProgress.percent = 0;
      introVideoUploadProgress.uploaded = 0;
    ...
    const startProcessingStages = () => {
      ...
      progressTracker.timeRemaining =
        progressTracker.estimatedProcessingTime +
        progressTracker.estimatedR2UploadTime;
      ...
      setTimeout(() => {
        ...
        processingIntervalId = setInterval(() => {
          ...
          const processingProgress = Math.min(
            80,
            45 + (elapsed / progressTracker.estimatedProcessingTime) * 35,
          );
          progressTracker.percent = Math.round(processingProgress);
          progressTracker.timeRemaining = Math.max(
            0,
            progressTracker.estimatedProcessingTime -
              elapsed +
              progressTracker.estimatedR2UploadTime,
          ...
          if (processingProgress >= 80) {
            ...
            r2UploadIntervalId = setInterval(() => {
              ...
              const r2Progress = Math.min(
                100,
                80 + (r2Elapsed / progressTracker.estimatedR2UploadTime) * 20,
              );
              progressTracker.percent = Math.round(r2Progress);
              progressTracker.timeRemaining = Math.max(
                0,
                progressTracker.estimatedR2UploadTime - r2Elapsed,
              );
      ...
      if (xhr.status >= 200 && xhr.status < 300) {
        ...
        try {
          ...
          if (xhr.status === 401) {
            ...
            errorMessage =
              "File quá lớn! Kích thước file không được vượt quá 5GB.";
          } else if (xhr.status === 503 || xhr.status === 504) {
            errorMessage =
              "Upload video mất quá nhiều thời gian. Vui lòng thử lại sau.";
          } else if (xhr.status === 400) {
            errorMessage =
              "Dữ liệu không hợp lệ. Vui lòng kiểm tra lại file video.";
          } else {
    ...
    xhr.addEventListener("error", (event) => {
      ...
      reject(
        new Error(
          "Lỗi kết nối khi upload video. Vui lòng kiểm tra kết nối mạng.",
        ),
      );
    });
...
const removeQuestion = (
  ...
  formData.chapters[chapterIndex].lessons[lessonIndex].quiz.questions.splice(
    questionIndex,
    1,
  );
};
...
const addOption = (
  ...
  const question =
    formData.chapters[chapterIndex].lessons[lessonIndex].quiz.questions[
      questionIndex
    ];
  if (!question.options) {
    question.options = [];
  ...
  try {
    ...
    if (response.status && response.data) {
      ...
      Object.assign(formData, {
        ...
        promotionStartDate: courseData.promotionStartDate
          ? dayjs(courseData.promotionStartDate)
          : null,
        promotionEndDate: courseData.promotionEndDate
          ? dayjs(courseData.promotionEndDate)
          : null,
      ...
      if (courseData.chapters && Array.isArray(courseData.chapters)) {
        ...
        formData.chapters = sortedChapters.map((chapter: any) => {
          const chapterStableId =
            chapter._id?.toString?.() || chapter._id || makeClientId("chapter");
                  ...
                  ? {
                      ...
                      questions: Array.isArray(lesson.quiz.questions)
                        ? lesson.quiz.questions.map((q: any, qIdx: number) => {
                            const questionStableId =
                              q.id ||
                              q._id?.toString?.() ||
                              q._id ||
                              `q-${lessonStableId}-${qIdx}`;
                            // Map options first
                            ...
                            if (correctAnswer && mappedOptions.length > 0) {
                              ...
                              if (!optionById) {
                                ...
                                const correctOption = mappedOptions.find(
...
const handleUserSelect = (userId: string) => {
  const selectedUser = usersList.value.find(
    (u: any) => (u._id || u.id) === userId,
  );
  if (selectedUser) {
    reviewFormData.userName =
      selectedUser.fullname || selectedUser.name || selectedUser.email || "";
    reviewFormData.userAvatar =
      selectedUser.avatar || "/images/avatar-demo.png";
...
const editReview = async (review: any, index: number) => {
  ...
  reviewFormData.isVerified =
    review.isVerified !== undefined ? review.isVerified : true;
  ...
  if (review.userId && review.userId !== "admin") {
    ...
    const matchedUser = usersList.value.find(
      (u: any) => (u.fullname || u.name || u.email) === review.userName,
    );
    if (matchedUser) {
      reviewFormData.userInputType = "select";
...
const saveReview = async () => {
  try {
    ...
    const userId =
      reviewFormData.userInputType === "select" && reviewFormData.selectedUserId
    ...
    if (editingReview.value) {
      ...
      const response: any = await $fetch(
        `${apiBase}/reviews/${editingReview.value._id}`,
        {
          method: "PUT",
          body: {
            userId,
      ...
      const index = courseReviews.value.findIndex(
        (r: any) => r._id === editingReview.value._id,
      );
      if (index !== -1) {
        const updatedReview = response.data?.review ||
          response.review || { ...editingReview.value, ...reviewFormData };
...
const handleModalOk = async () => {
  try {
    ...
    if (
      thumbnailFileList.value.length > 0 &&
      thumbnailFileList.value[0].originFileObj
    ) {
      formData.thumbnail = await uploadFileToMinIO(
        thumbnailFileList.value[0].originFileObj as File,
        "courses/thumbnails",
      );
    }
    ...
    if (
      ...
      const videoData = await uploadVideoToR2(
        introVideoFileList.value[0].originFileObj as File,
    ...
    // Nếu không có file mới nhưng có URL (khi edit hoặc đã upload), giữ nguyên URL
      ...
      introVideoFileList.value.length > 0 &&
      introVideoFileList.value[0].url
    ) {
    ...
    if (
      introVideoThumbnailFileList.value.length > 0 &&
      introVideoThumbnailFileList.value[0].originFileObj
    ) {
      const uploadsApi = useUploadsApi();
    ...
    // Nếu không có file mới nhưng có URL trong fileList (khi edit hoặc đã upload), giữ nguyên URL
      ...
      introVideoThumbnailFileList.value.length > 0 &&
      introVideoThumbnailFileList.value[0].url
    ) {
    ...
    if (
      instructorAvatarFileList.value.length > 0 &&
      instructorAvatarFileList.value[0].originFileObj
    ) {
      formData.instructor.avatar = await uploadFileToMinIO(
        instructorAvatarFileList.value[0].originFileObj as File,
        "instructors",
      );
    }
    // Nếu không có file mới nhưng có URL (khi edit), giữ nguyên URL
      ...
      instructorAvatarFileList.value.length > 0 &&
      instructorAvatarFileList.value[0].url
    ) {
    ...
    for (const ch of formData.chapters) {
      if (ch.lessons) {
        for (const lesson of ch.lessons) {
          if (
            lesson.videoThumbnailFileList &&
            lesson.videoThumbnailFileList.length > 0
          ) {
    ...
    const payload: any = {
      ...
      chapters: formData.chapters.map((ch, idx) => ({
        ...
        index: idx,
        lessons:
          ch.lessons?.map((lesson: any, lessonIdx: number) => {
              ...
              const validQuestions = (lesson.quiz.questions || [])
                .map((q: any, qIdx: number) => {
                  const stableQuestionId =
                    ...
                    q._id?.toString?.() ||
                    q._id ||
                    `q-${lesson._id || lesson._clientId || lessonIdx}-${qIdx}`;
                  // Map options first to ensure all have ids
                  const mappedOptions = (q.options || []).map(
                    (opt: any, optIdx: number) => ({
                      id:
                        opt.id ||
                        opt._id?.toString?.() ||
                        opt._id ||
                        `opt-${stableQuestionId}-${optIdx}`,
                      text: opt.text || "",
                      isCorrect: opt.isCorrect || false,
                    }),
                  );
                    ...
                    if (typeof q.correctAnswer === "number") {
                      ...
                      const optionById = mappedOptions.find(
                        (opt: any) =>
                          ...
                          opt._id?.toString() === q.correctAnswer,
                      );
                      if (optionById) {
    ...
    if (
      ...
      message.warning(
        firstMsg || "Vui lòng kiểm tra lại các trường bắt buộc trong form",
      );
      return;
    }
    ...
    if (
      apiMessage.includes("validation failed") ||
      ...
      if (apiMessage.includes("chapters validation failed")) {
        ...
        if (fieldMatch) {
          ...
          apiMessage =
            "Lỗi validation: Một số chương học thiếu thông tin bắt buộc. Vui lòng kiểm tra lại các chương học.";
        }
        ...
        if (fieldMatch) {
          ...
          apiMessage =
            "Lỗi validation: Một số bài học thiếu thông tin bắt buộc. Vui lòng kiểm tra lại các bài học.";
        }
      } else if (
        apiMessage.includes("Quiz validation failed") ||
        apiMessage.includes("questions")
      ) {
        ...
        if (questionMatch) {
          ...
          apiMessage =
            "Lỗi validation: Một số câu hỏi trong bài kiểm tra thiếu thông tin bắt buộc. Vui lòng kiểm tra lại và đảm bảo tất cả các câu hỏi đã có nội dung và đáp án đúng.";
        }
      } else {
  ...
  try {
    ...
    if (response.status && response.data) {
      ...
      if (Array.isArray(courses.value)) {
        ...
        stats.active = courses.value.filter(
          (c) => c.status === "active",
        ).length;
  ...
  if (fileList.length > 0 && fileList[0].originFileObj) {
    ...
    try {
      ...
      if (
        lesson._id &&
        videoData.jobId &&
        (videoData.status === "queueing" || videoData.status === "processing")
      ) {
        try {
...
const pollIntroVideoJobStatus = async (jobId: string) => {
  ...
  introVideoPollInterval.value = setInterval(async () => {
    try {
      ...
      const errorMessage =
        jobData?.errorMessage ?? jobData?.data?.errorMessage ?? null;
      ...
      if (jobStatus === "ready") {
        ...
        if (jobResult) {
          formData.introVideo =
            jobResult.hlsUrl || jobResult.url || formData.introVideo;
          formData.introVideoHlsUrl =
            jobResult.hlsUrl || formData.introVideoHlsUrl;
          formData.introVideoStatus = "ready";
          // Thumbnail sẽ được upload thủ công, không tự động từ video
          formData.introVideoQualityMetadata =
      ...
      if (pollCount >= maxPolls) {
        ...
        if (
          ...
          formData.introVideoStatus = "error";
          formData.introVideoErrorMessage =
            "Timeout: Video processing took too long or server error";
          uploadingIntroVideo.value = false;
          // Clear progress on error
          introVideoUploadProgress.percent = 0;
          introVideoUploadProgress.stage = "";
...
const pollLessonVideoJobStatus = async (
  chapterIndex: number,
  lessonIndex: number,
  jobId: string,
) => {
      ...
      if (jobStatus === "ready") {
        ...
        if (lesson.videos.length > 0 && jobResult) {
          lesson.videos[0] = {
            ...lesson.videos[0],
            videoUrl:
              jobResult.hlsUrl || jobResult.url || lesson.videos[0].videoUrl,
            hlsUrl: jobResult.hlsUrl || lesson.videos[0].hlsUrl,
            thumbnail:
              lesson.videoThumbnail || lesson.videos[0].thumbnail || "", // Giữ thumbnail đã upload thủ công, không tự động từ video
            status: "ready",
            qualityMetadata:
              jobResult.qualityMetadata || lesson.videos[0].qualityMetadata,
            errorMessage: "",
          };
        ...
        if (progressKey && lessonVideoUploadProgress[progressKey]) {
          ...
          lessonVideoUploadProgress[progressKey].stage =
            progress >= 85
              ? "uploading-r2"
              : progress >= 70
                ? "processing"
...
const handleLessonDocumentChange = async (
  chapterIndex: number,
  lessonIndex: number,
  info: any,
) => {
  ...
  if (fileList.length > 0 && fileList[0].originFileObj) {
    ...
    try {
      ...
      const documentUrl = await uploadFileToMinIO(
        file,
        `courses/documents/${Date.now()}`,
      );
      ...
      message.error(
        "Upload tài liệu thất bại: " + (error.message || "Unknown error"),
      );
