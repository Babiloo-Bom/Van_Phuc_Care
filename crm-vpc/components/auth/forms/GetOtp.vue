<template>
    ...
    >
        <a-form-model-item v-if="!showOtp" label="Vui lòng nhập email của bạn" prop="email">
            <a-input
                v-model="form.email"
                :disabled="showOtp"
                size="large"
            ...
            async handleSubmit() {
                if (!this.showOtp) {
                    ...
                    try {
                        ...
                        const data = await this.$api.auth.verifyOtp({
                            ...this.form,
                            origin: 'vanphuccare.gensi.vn',
                        });
                        this.$emit('submit', {
                        ...
                        this.$message.error('Mã OTP không đúng!');
                        this.$handleError(e);
                    }
                }
            },
