    ...
    <div class="card !p-0 bg-white !rounded-[12px] h-full">
        <div class="h-full flex flex-col justify-between">
            <div class="relative">
                ...
                <div class="p-4">
                    <span>
                        <h4 class="text-[18px] m-0 font-bold text-[#1A75BB]">
                            {{ course.title || 'Dạy toán cho bé' }}
                        </h4>
                    </span>
                    <p class="mt-4 text-[#8C8C8C] line-clamp-4">
                        {{ course.shortDescriptions || 'Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s' }}
                    </p>
                    <div class="flex items-center gap-4">
                        <div class="flex items-center justify-start gap-1">
                            ...
                            <span class="font-[600] text-[#000000]">{{ course.videos && course.videos.length || 2 }} video</span>
                        </div>
                        <div class="flex items-center justify-start gap-1">
                            <span>
                                <svg
                            ...
                            <span class="font-[600] text-[#000000]">{{ course.documents && course.documents.length || 1 }} tài liệu</span>
                        </div>
                    </div>
                    <div class="flex items-center justify-start gap-1">
                        <span>
                        ...
                        <span class="font-[600] text-[#000000]">{{ course.exams && course.exams.length || 1 }} bài trắc nghiệm</span>
                    </div>
                </div>
            </div>
            <div class="px-4 mt-[2px]">
                <div class=" border-t-[1px] border-[#8C8C8C] py-4">
                    ...
                    <div class="flex items-center justify-start mt-1">
                        <a-rate style="fontSize: 14px;color: #FFD74B; marginRight: 0px" :default-value="course.rate || 5" disabled />
                        <p class="m-0 text-[12px] mt-[1px] ml-[4px] text-[#868686]">
                            ({{ course.reviews || 5 }} đánh giá)
                        </p>
                    </div>
                </div>
            </div>
