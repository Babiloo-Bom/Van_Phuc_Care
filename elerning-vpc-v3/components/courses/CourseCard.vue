  ...
  <div class="course-card" @click="viewDetail">
    ...
    <div class="course-content">
      ...
      <div class="course-price" v-else>
        ...
        <div class="price-discount" v-if="course.discount > 0">-{{ course.discount }}%</div>
      </div>
      ...
      <div class="course-stats">
        ...
        />
        <span class="rating-count">({{ course.rating?.count || 0 }} lượt đánh giá)</span>
      </div>

      <div class="flex justify-between items-center flex-wrap gap-2 my-4">
        <div class="flex justify-between items-center gap-1">
          ...
          <span class="text-xs text-[#393939]">{{ course.videoCount }} video</span>
        </div>
        <div class="flex justify-between items-center gap-2">
          ...
          <span class="text-xs text-[#393939]">{{ course.lessons }} Tài liệu</span>
        </div>
        <div class="flex justify-between items-center gap-2">
          <svg xmlns="http://www.w3.org/2000/svg" width="10" height="10" viewBox="0 0 9 9" fill="none">
            <path
          ...
          <span class="text-xs text-[#393939]">{{ course.students }} Bài trắc nghiệm</span>
        </div>
      </div>
