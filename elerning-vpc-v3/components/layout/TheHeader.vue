    ...
    <div class="container mx-auto px-4">
      <div class="flex items-center justify-between h-16">
        ...
        <div class="flex items-center gap-2 sm:gap-4">
          ...
          <NuxtLink
            to="/cart"
            class="relative p-2 hover:bg-white/10 rounded-lg transition-colors shrink-0"
          >
            <svg
            ...
            >
              <path
                d="M3 3h2l.4 2M7 13h10l4-8H5.4M7 13L5.4 5M7 13l-2.293 2.293c-.63.63-.184 1.707.707 1.707H17M17 13v6a2 2 0 0 1-2 2H9a2 2 0 0 1-2-2v-6m8 0V9a2 2 0 0 0-2-2H9a2 2 0 0 0-2 2v4.01"
                stroke-width="1.5"
          ...
          <div v-if="isLoggedIn" class="flex items-center gap-3">
            ...
            <a-button type="text" @click="handleLogout"> Đăng xuất </a-button>
          </div>
